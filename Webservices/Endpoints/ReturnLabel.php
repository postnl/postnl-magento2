...
use TIG\PostNL\Webservices\Parser\Label\AbstractShipmentLabel;
...
class ReturnLabel extends Labelling
{
    protected AbstractShipmentLabel $returnShipmentData;
    ...
    public function __construct(
        ...
        AbstractShipmentLabel      $returnShipmentData
    ) {
        parent::__construct(
            $soap,
            $customer,
