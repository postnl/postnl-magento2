...
![Avondbezorging]({{ base_url }}/assets/images/3_bezorging_avondbezorging.png "PostNL Avondbezorging")
...
![Zondagbezorging]({{ base_url }}/assets/images/3_bezorging_zondagbezorging.png "PostNL Zondagbezorging")
...
![Bezorgdagen]({{ base_url }}/assets/images/3_bezorging_bezorgdagen.png "PostNL Bezorgdagen")
...
![PostNL Locaties]({{ base_url }}/assets/images/3_bezorging_postnl_locaties.png "PostNL Locaties")
...
![PostNL niet bij buren leveren]({{ base_url }}/assets/images/3_bezorging_niet_bij_buren.png "PostNL niet bij buren leveren")
...
![Voorraadinstellingen]({{ base_url }}/assets/images/3_bezorging_voorraadinstellingen.png "PostNL Voorraadinstellingen")
...
![PostNL ID Check]({{ base_url }}/assets/images/3_bezorging_id_check.png "PostNL ID Check")
...
![PostNL Cargo]({{ base_url }}/assets/images/3_bezorging_cargo.png "PostNL Cargo")
...
![PostNL Pakjes Tracked]({{ base_url }}/assets/images/3_bezorging_pakjes_tracked.png "PostNL Pakjes Tracked")
...
![PostNL EU en België]({{ base_url }}/assets/images/3_bezorging_eu_belgie.png "PostNL EU en Belgie")
...
![PostNL Extra@Home]({{ base_url }}/assets/images/3_bezorging_extra@home.png "PostNL Extra@Home")
...
![PostNL Track and Trace]({{ base_url }}/assets/images/3_bezorging_track_trace.png "PostNL Track and Trace")
...
![PostNL Track and Trace template]({{ base_url }}/assets/images/3_bezorging_track_trace_template.png "PostNL Track and Trace template")
...
![PostNL Track and Trace template selectie]({{ base_url }}/assets/images/3_bezorging_track_trace_template_selectie.png "PostNL Track and Trace template selectie")
...
![PostNL Brievenbuspakje]({{ base_url }}/assets/images/3_bezorging_brievenbuspakje.png "PostNL Brievenbuspakje")
...
![PostNL Brievenbuspakje productinstellingen]({{ base_url }}/assets/images/3_bezorging_brievenbuspakje_productinstellingen.png "PostNL Brievenbuspakje productinstellingen")
...
- **Per bestelling:** Open hiervoor vanuit het bestellingenoverzicht een bestelling en klik op de optie om de bestelling te versturen. Onderaan de pagina kan er vervolgens bij de Verzending opties een *PostNL Bezorgoptie* geselecteerd worden. Kies in dit geval voor *Brievenbuspakje Extra*.
  ![PostNL Brievenbuspakje verzenden]({{ base_url }}/assets/images/3_bezorging_brievenbuspakje_verzenden.png "PostNL Brievenbuspakje verzenden")
