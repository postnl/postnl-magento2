...
class ShippingOptions extends AbstractConfigProvider
{
    ...
    const XPATH_SHIPPING_OPTION_PACKAGE_MACHINE_FILTER_ACTIVE  = 'tig_postnl/post_offices/package_machine_filter_active';
    ...
    {
        return $this->getConfigFromXpath(self::XPATH_SHIPPING_OPTION_PACKAGE_MACHINE_FILTER_ACTIVE);
    }
