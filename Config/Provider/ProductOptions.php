...
{
    const XPATH_SUPPORTED_PRODUCT_OPTIONS               = 'tig_postnl/delivery_options/supported_options';
    const XPATH_DEFAULT_PRODUCT_OPTION                  = 'tig_postnl/delivery_options/default_option';
    const XPATH_USE_ALTERNATIVE_DEFAULT_OPTION          = 'tig_postnl/delivery_options/use_alternative_default';
    const XPATH_ALTERNATIVE_DEFAULT_MIN_AMOUNT          = 'tig_postnl/delivery_options/alternative_default_min_amount';
    const XPATH_ALTERNATIVE_DEFAULT_PRODUCT_OPTION      = 'tig_postnl/delivery_options/alternative_default_option';
