...
class MatrixrateTest extends TestCase
{
    ...
    public function testHasTheCorrectHeaders()
    {
        ...
        $this->assertContains('Land', $header);
        $this->assertContains('Provincie/staat', $header);
        $this->assertContains('Postcode', $header);
        $this->assertContains('Gewicht (en hoger)', $header);
        $this->assertContains('Bedrag (en hoger)', $header);
        $this->assertContains('Hoeveelheid (en hoger)', $header);
        $this->assertContains('pakkettype', $header);
        $this->assertContains('prijs', $header);
        $this->assertContains('Instructies', $header);
    }
