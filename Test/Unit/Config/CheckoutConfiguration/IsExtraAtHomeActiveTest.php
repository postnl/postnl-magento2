...
use TIG\PostNL\Config\CheckoutConfiguration\IsExtraAtHomeActive;
use TIG\PostNL\Config\Provider\ShippingOptions;
use TIG\PostNL\Test\TestCase;

class IsExtraAtHomeTest extends TestCase
{
    public $instanceClass = IsExtraAtHomeActive::class;
    ...
    public function testGetValue($expected)
    {
        ...
        $shippingOptions->expects($this->once())->method('IsExtraAtHomeActive')->willReturn($expected);
