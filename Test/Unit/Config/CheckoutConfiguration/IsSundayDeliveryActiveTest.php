...
use TIG\PostNL\Config\CheckoutConfiguration\IsSundayDeliveryActive;
use TIG\PostNL\Config\Provider\ShippingOptions;
use TIG\PostNL\Test\TestCase;

class IsSundayDeliveryActiveTest extends TestCase
{
    public $instanceClass = IsSundayDeliveryActive::class;
    ...
    public function testGetValue($expected)
    {
        ...
        /** @var IsSundayDeliveryActive $instance */
