 ...
 */
namespace TIG\PostNL\Unit\Services\Shipping;
...
{
    protected $instanceClass = CalculateTablerateShippingPrice::class;
    ...
    public function testGetTableratePrice()
    {
        ...
        $tablerateMock = $this->getFakeMock(Tablerate::class)->setMethods(['getRate'])->getMock();
